      ...
      <div className="w-screen flex flex-wrap items-center justify-center md:justify-between mx-auto p-4">
        ...
        <div className={`${open ? "block" : "hidden"} w-[80vw] md:block md:w-auto`} id="navbar-default">
          <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4	flex flex-col md:flex-row flex-wrap items-center text-base justify-center">
            <a className="mr-5 p-2 md:p-0 text-xl font-medium hover:text-gray-900">Features</a>
            <a className="mr-5 p-2 md:p-0 text-xl font-medium hover:text-gray-900">Pricing</a>
            <a className="mr-5 p-2 md:p-0 text-xl font-medium hover:text-gray-900">Resources</a>
          </nav>
          <div className="flex flex-col md:hidden md:flex-row">
            <button className="py-1 px-3 focus:outline-none bg-white mr-2 text-gray-600 hover:text-gray-900 text-xl font-medium">Login</button>
