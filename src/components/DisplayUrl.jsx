    ...
    <section className="bg-custom-gray bg-opacity-25 pt-32 gap-4">
      {result?.map(item => (
        <div className="p-3 custom-card bg-white w-[80vw] m-auto rounded-lg flex flex-col md:flex-row justify-items-center place-items-center mt-4" key={item}>
          <p className="flex-1 w-full md:flex-1 border-b-2 md:border-none p-2 md:p-0 break-all">{item.result.original_link}</p>
          ...
          <button
            className={`break-all border-0 py-2 text-center w-full md:w-24 focus:outline-none rounded-lg text-white ${
